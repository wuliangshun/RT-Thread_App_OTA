...
#define PKG_USING_LIBSODIUM

/* Examples */

/* end of Examples */

/* Testing (It's suggested to pass all required tests first) */

/* end of Testing (It's suggested to pass all required tests first) */
#define PKG_USING_LIBSODIUM_LATEST_VERSION
